...
namespace ChatHerder.Infrastructure.Migrations
{
    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ContextSequences",
                columns: table => new
                {
                    ContextType = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    ContextId = table.Column<Guid>(type: "uuid", nullable: false),
                    NextValue = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContextSequences", x => new { x.ContextType, x.ContextId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalDialogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonalDialogs_Users_User1Id",
                        column: x => x.User1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PersonalDialogs_Users_User2Id",
                        column: x => x.User2Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlatformBans_Users_IssuedByAdminId",
                        column: x => x.IssuedByAdminId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlatformBans_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContextType = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    ContextId = table.Column<Guid>(type: "uuid", nullable: false),
                    LastReadSequenceNumber = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadMarkers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadMarkers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeepSignedIn = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    RevokedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalDialogMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonalDialogMessages_PersonalDialogMessages_ReplyToMessag~",
                        column: x => x.ReplyToMessageId,
                        principalTable: "PersonalDialogMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PersonalDialogMessages_PersonalDialogs_DialogId",
                        column: x => x.DialogId,
                        principalTable: "PersonalDialogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonalDialogMessages_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomInvitations_Users_InvitedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalDialogMessageId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attachments_PersonalDialogMessages_PersonalDialogMessageId",
                        column: x => x.PersonalDialogMessageId,
                        principalTable: "PersonalDialogMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_RoomId_SequenceNumber",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalDialogMessages_AuthorId",
                table: "PersonalDialogMessages",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalDialogMessages_DialogId_SequenceNumber",
                table: "PersonalDialogMessages",
                columns: new[] { "DialogId", "SequenceNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PersonalDialogMessages_ReplyToMessageId",
                table: "PersonalDialogMessages",
                column: "ReplyToMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalDialogs_User1Id_User2Id",
                table: "PersonalDialogs",
                columns: new[] { "User1Id", "User2Id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PersonalDialogs_User2Id",
                table: "PersonalDialogs",
                column: "User2Id");

            migrationBuilder.CreateIndex(
                name: "IX_PlatformBans_IssuedByAdminId",
                table: "PlatformBans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadMarkers_UserId_ContextType_ContextId",
                table: "ReadMarkers",
