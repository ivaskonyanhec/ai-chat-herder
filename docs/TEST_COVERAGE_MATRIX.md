...
| FR-2.1.2-3 | Username is immutable after registration | E2E/UAT | `e2e/tests/01-auth.spec.ts`, `e2e/tests/uat/01-onboarding.uat.spec.ts` | username cannot be changed through UI | BLOCKED | Profile UI is static and no username update path is exposed. |
...
| FR-2.1.4-2 | Password change for logged-in users | E2E | None | None | NOT COVERED | No UI flow; API could be added in future E2E. |
...
| FR-2.1.5-3 | Deleting account removes memberships in other rooms | E2E | None | None | NOT COVERED | Needs multi-room account deletion scenario. |
...
| FR-2.3.3-1 | Recipient confirms friendship | E2E | None | None | BLOCKED | Friend confirmation endpoint/UI absent. |
| FR-2.3.4-1 | Remove friend | E2E | None | None | BLOCKED | Friend endpoint/UI absent. |
| FR-2.3.5-1 | User-to-user ban blocks contact and freezes existing PMs | E2E | None | None | BLOCKED | User block endpoints/UI absent. |
| FR-2.3.6-1 | Personal messages only between unblocked friends | E2E | None | None | BLOCKED | Friendship and dialog endpoint flows absent. |
...
| FR-2.4.2-2 | Room names are unique | E2E | None | None | NOT COVERED | Add duplicate room creation test. |
| FR-2.4.3-1 | Public room catalog with name/description/member count | E2E | None | None | NOT COVERED | API exists; no E2E assertion yet. |
| FR-2.4.3-2 | Public catalog supports search | E2E | None | None | NOT COVERED | API exists; no E2E assertion yet. |
...
| FR-2.4.4-1 | Private rooms hidden from public catalog and invitation-only | E2E | None | None | NOT COVERED | Invitation API exists but no full E2E flow. |
| FR-2.4.5-1 | Users may leave rooms; owner cannot leave | E2E | None | None | NOT COVERED | Add leave/owner-leave API and UI tests. |
...
| FR-2.4.9-1 | Invite users to private rooms | E2E | None | None | NOT COVERED | Invitation API exists; no E2E/UAT scenario yet. |
| FR-2.5.1-1 | Personal dialogs behave like chats | E2E | None | None | BLOCKED | Direct message UI is static; dialog setup API not mapped. |
...
| FR-2.5.4-1 | Users can edit own messages and UI shows edited indicator | E2E | None | None | NOT COVERED | Hub/API exists; no E2E scenario added. |
| FR-2.5.5-1 | Messages can be deleted by author/admin | E2E | None | None | NOT COVERED | Hub/API exists; no E2E scenario added. |
| FR-2.5.6-1 | Persistent chronological history and infinite scroll; offline delivery | E2E/UAT | `e2e/tests/02-chat.spec.ts`, `e2e/tests/uat/03-realtime-messaging.uat.spec.ts` | message remains available via history refetch | PARTIALLY COVERED | Persistence/history refetch covered; chronological order, infinite scroll, offline recipient UI not covered. |
